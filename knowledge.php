   <?php include 'header.php';?>
    <div class="row">
          <div class="col-lg-12">
            <h1>ความรู้เกี่ยวกับความเสี่ยง </h1>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            ...
            <div class="bs-example">
              <ul class="nav nav-tabs" style="margin-bottom: 15px;">
                <li class="active"><a href="#home" data-toggle="tab">คำจำกัดความ</a></li>
              ...
              <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade active in" id="home">
                  <ul>
		                  <li><label>ความเสี่ยง</label> หมายถึง โอกาสที่จะประสบกับความสูญเสีย หรือสิ่งไม่พึงประสงค์ โอกาสความน่าจะเป็นที่จะเกิดอุบัติการณ์</li>
		                  <li><label>อุบัติการณ์ (incident)</label> หมายถึง เหตุการณ์ที่เกิดขึ้น ซึ่งอาจทำให้เกิดอันตรายต่อร่างกาย,จิตใจ,ชื่อเสียง,ทรัพย์สิน สิ่งแวดล้อม  ก่อให้เกิดความไม่พึงพอใจ คำร้องเรียนหรือการฟ้องร้อง
		  อุบัติการณ์ที่เกิดกับผู้ป่วยรายแรก คือ ความเสี่ยงที่จะเกิดอันตรายกับผู้ป่วยรายอื่น ๆ</li>
						 <li><label>เหตุการณ์ไม่พึงประสงค์ (adverse event) </label> คือ อุบัติการณ์ที่ก่อให้เกิดอันตรายต่อผู้ป่วย ครอบคลุมถึงการเกิดโรค ภาวะแทรกซ้อน การบาดเจ็บ ความทุกข์ทรมาน ความพิการ และการเสียชีวิต
		     และอาจจะเป็นอันตรายทางด้านสังคม หรือจิตใจ</li>
						 <li><label>sentinel event</label> คือ ความเสี่ยงที่เฝ้าระวังเป็นพิเศษหรือเหตุการณ์ไม่พึงประสงค์ที่ก่อให้เกิดการเสียชีวิตหรืออันตรายขั้นรุนแรง ที่ต้องตื่นตัว ใส่ใจ ให้ความสำคัญสูง</li>
						 <li><label>แนวโน้มจะเกิดความเสี่ยง (near miss ) </label> คือ การกระทำหรือละเว้นการกระทำซึ่งอาจส่งผลให้เกิดอันตรายต่อผู้ป่วย แต่ไม่เกิดอันตรายเนื่องจากความบังเอิญ การป้องกัน หรือการทำให้ปัญหาทุเลาลง</li>
				 		<li><label>วัฒนธรรมความปลอดภัย (safety culture) </label> คือคุณลักษณะขององค์กรในด้านความปลอดภัยดังนี้ <br /> 
							(1)  การรับรู้ถึงธรรมชาติขององค์กรที่มีความเสี่ยงสูง มีโอกาสเกิดความผิดพลั้ง <br /> 
							(2)  ลักษณะองค์กรที่ไม่มีการตำหนิกัน บุคลากรสามารถรายงานความผิดพลั้ง โดยไม่ต้องหวาดกลัวว่าจะถูกลงโทษ <br />
							(3)  มีความร่วมมือกันอย่างกว้างขวางเพื่อป้องกันความเสี่ยงต่าง ๆ <br />
							(4)  ความเต็มใจขององค์กรที่จะสนับสนุนทรัพยากรเพื่อความปลอดภัย <br />
						</li>  
                  </ul>
                  <h1><small>ระดับความรุนแรงของการเกิดอุบัติการณ์ แบ่งเป็น 9 ระดับ ดังนี้</small></h1>
 				<ul>		                  
					<li><label>	A	</label> ไม่มีความคลาดเคลื่อน แต่มีโอกาสที่จะก่อให้เกิดความคลาดเคลื่อน </li>
					<li><label>	B	</label> เกิดความคลาดเคลื่อนขึ้น แต่ไม่เป็นอันตราย/ไม่ส่งผลเสียหายเนื่องจากความคลาดเคลื่อนยังไม่ถึงผู้มารับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน และองค์กร</li>
					<li><label>	C  </label> เกิดความคลาดเคลื่อน แต่ไม่เป็นอันตราย/ไม่ส่งผลเสียหายถึงแม้ว่าความคลาดเคลื่อนนั้นจะไปถึงผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน และองค์กรแล้ว และองค์กร</li>
					<li><label>	D	</label> เกิดความคลาดเคลื่อน แต่ไม่เป็นอันตราย/ไม่ส่งผลเสียหาย แต่ต้องมีการเฝ้าระวังเพื่อให้มั่นใจว่าไม่เป็นอันตราย/ไม่ส่งผลเสียหายต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน และองค์กร</li>
					<li><label>	E	</label> เกิดความคลาดเคลื่อน ส่งผลให้เกิดอันตรายชั่วคราวต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงานและองค์กร ต้อง ได้รับการรักษา/แก้ไขเพิ่มเติม </li>
					<li><label>	F	</label> เกิดความคลาดเคลื่อน เกิดอันตรายชั่วคราวต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน ต้องนอนโรงพยาบาลนานขึ้น ใช้เวลาแก้ไขนานขึ้น</li>
					<li><label>	G	</label> เกิดความคลาดเคลื่อน เกิดอันตรายถาวรต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน และองค์กร</li>
					<li><label>	H	</label> เกิดความคลาดเคลื่อน เกิดอันตรายเกือบถึงชีวิตต่อผู้รับบริการ ต้องทำการช่วยชีวิต เกิดความเสียหายต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงาน และองค์กรต้องมีการแก้ไขอย่างเร่งด่วน (CPR)</li>
					<li><label>	I	</label> เกิดความคลาดเคลื่อน เกิดอันตรายจนถึงชีวิตต่อผู้รับบริการ เกิดความเสียหายจนแก้ไขไม่ได้ ต่อผู้รับบริการ เครื่องมือ อุปกรณ์ กระบวนการทำงานและทำให้เสื่อมเสียชื่อเสียง ถูกฟ้องร้องทางสื่อ ทางกฎหมาย</li>
               </ul>	 
                </div>
